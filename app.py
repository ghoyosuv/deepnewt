...
def parse_args():
    default_sents = pd.read_csv("https://raw.githubusercontent.com/Cletsxd/tweets_exp_966/master/tweets/sents.csv")
    default_tweets = pd.read_csv("https://raw.githubusercontent.com/Cletsxd/tweets_exp_966/master/tweets/tweets.csv")

    parser = argparse.ArgumentParser()
    parser.add_argument("--verbose", "-v", help="Verbose", action="store_true")
    parser.add_argument("--sents", const=default_sents,  type=str, help="file or url to sents.csv")
    parser.add_argument("--tweets",const=default_tweets, type=str, help="file or url to tweets.csv")
