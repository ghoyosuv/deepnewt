...
def parse_args():
    default_sents = "https://raw.githubusercontent.com/Cletsxd/tweets_exp_966/master/tweets/sents.csv"
    default_tweets = "https://raw.githubusercontent.com/Cletsxd/tweets_exp_966/master/tweets/tweets.csv"

    parser = argparse.ArgumentParser()
    parser.add_argument("--verbose", "-v", help="Verbose", action="store_true")
    parser.add_argument("--sents", 		default=default_sents, 	nargs='?', const=1, 	type=str, 	help="file or url to sents.csv")
    parser.add_argument("--tweets",		default=default_tweets, nargs='?', const=1, 	type=str, 	help="file or url to tweets.csv")
    parser.add_argument("--phiA",		default=0.2, 		nargs='?', const=1, 	type=float, 	help="phiA")
    parser.add_argument("--phiB",		default=0.1, 		nargs='?', const=1, 	type=float, 	help="phiB")
    parser.add_argument("--ntournament",	default=6, 		nargs='?', const=1,   	type=int, 	help="n_tournament")
    parser.add_argument("--ar_name",		default="A1", 		nargs='?', const=1,	type=str, 	help="ar_name")
...
input_sents = args.sents
input_tweets = args.tweets
if args.verbose:
...
log.debug("reading sents from: "+input_sents)
log.debug("reading tweets from: "+input_tweets)
sents = pd.read_csv(input_sents)
tweets = pd.read_csv(input_tweets)
